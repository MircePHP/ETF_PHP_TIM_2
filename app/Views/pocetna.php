...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="#">Prijava master rada</a></li>
			<li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Biografija</a>
			</li>
			<li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Obrazloženje teme</a></li>
	...
	<div class="heroe">
		...
		<h2>Mesto ge bi bila input polja za login</h2>
